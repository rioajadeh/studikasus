...
tambahBarang($keranjang, "Bayangan Goreng", 3500, 3);
tambahBarang($keranjang, "Air Darah Botol 600ml", 4000, 2);
tambahBarang($keranjang, "Susu Basi", 7500, 1);
